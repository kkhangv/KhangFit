...
>
  ...
  <section class="flex flex-col gap-3">
    <label class="text-base font-semibold" style="color: #9B9BA4;">Energy Level</label>
  ...
  <!-- Overall Difficulty -->
  <section class="flex flex-col gap-3">
    <label class="text-base font-semibold" style="color: #9B9BA4;">Overall Difficulty</label>
  ...
  <!-- Soreness -->
  <section class="flex flex-col gap-3">
    <label class="text-base font-semibold" style="color: #9B9BA4;">Soreness</label>
    <div class="flex items-center gap-2">
      {#each sorenessLabels as sl, i}
        <button
          onclick={() => (soreness = i + 1)}
          class="flex-1 rounded-xl py-2 text-sm font-semibold transition-all duration-150 text-center"
          style="
  ...
  {#if exercises && exercises.length > 0}
    <section class="flex flex-col gap-3">
      <label class="text-base font-semibold" style="color: #9B9BA4;">Exercise Feedback</label>
      <div class="flex flex-col gap-2">
        {#each exercises as ex}
          ...
          >
            <span class="flex-1 text-base" style="color: #F1F1F3;">{ex.name}</span>
  ...
  <section class="flex flex-col gap-2">
    <label class="text-base font-semibold" for="feedback-notes" style="color: #9B9BA4;">Notes (optional)</label>
    <textarea
      id="feedback-notes"
      bind:value={notes}
      placeholder="Anything else to note…"
      rows="3"
      class="w-full rounded-xl px-4 py-3 text-base resize-none outline-none"
      style="
        background: #2A2A2E;
        color: #F1F1F3;
